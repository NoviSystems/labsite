...
urlpatterns = [
    ...
    url(r'^stripe/cards/$', views.StripeListView.as_view(), name='stripe_card_list'),
    ...
    url(r'^stripe/cards/update$', views.StripeCreateView.as_view(), name='stripe_card_update'),
    url(r'^stripe/cards/delete/(\w+)/$', views.StripeDeleteView.as_view(), name='stripe_card_delete'),
