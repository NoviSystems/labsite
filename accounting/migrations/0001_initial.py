# -*- coding: utf-8 -*-
# Generated by Django 1.9.12 on 2017-02-06 17:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actual_amount', models.DecimalField(decimal_places=2, default=None, max_digits=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('department', models.CharField(default='CSC', max_length=4)),
                ...
                ('state', models.CharField(choices=[('ACTIVE', 'Active'), ('COMPLETE', 'Complete')], default='ACTIVE', max_length=8)),
        ...
        migrations.AlterUniqueTogether(
            name='invoice',
            unique_together=set([('contract', 'number')]),
        ),
        migrations.AlterUniqueTogether(
            name='fulltimepayroll',
            unique_together=set([('month', 'year')]),
